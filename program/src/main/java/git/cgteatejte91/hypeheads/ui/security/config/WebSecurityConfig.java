package git.cgteatejte91.hypeheads.ui.security.config;

import git.cgteatejte91.hypeheads.ui.jwt.JwtUsernameAndPasswordAuthenticationFilter;
import git.cgteatejte91.hypeheads.ui.service.User.WebsiteUserService;
import git.cgteatejte91.hypeheads.ui.jwt.JwtConfig;
import git.cgteatejte91.hypeheads.ui.jwt.JwtTokenVerifier;
...
import static git.cgteatejte91.hypeheads.ui.model.User.UserRole.*;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .authorizeRequests().antMatchers("/", "index", "/css/*", "/js/*",
                    "/api/registration/**", "/api/products/**","/api/orders/**", "/management/api/websiteuser/**", "/api/token/**").permitAll()
        .antMatchers("/api/websiteuser/**", "api/keys/paypal/**").hasAnyRole(CUSTOMER.name(),SELLER.name())
